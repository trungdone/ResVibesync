...
export default function TopSongs() {
      ...
      try {
        ...
        const vietnameseSongs = data.filter((song) => {
          ...
          if (typeof genre === "string") {
            return genre.toLowerCase() === "edm";
          }
          if (Array.isArray(genre)) {
            return genre.some(
              (g) => typeof g === "string" && g.toLowerCase() === "edm"
            );
          }
          return false;
        });

        setSongs(vietnameseSongs);
      } catch (err) {
  ...
  if (!songs.length) return <p>No EDM songs found.</p>;
  ...
  return (
    <div className="flex h-[80vh] p-4 gap-6 overflow-hidden">
      ...
      <div className="w-80 bg-gradient-to-b from-pink-500 to-pink-700 text-white rounded-xl p-4 shrink-0">
        ...
        />
        <h2 className="text-xl font-bold mb-2">Top 100 Bài Hát Nhạc EDM Hay Nhất</h2>
